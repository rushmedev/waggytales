...
export const metadata: Metadata = {
  title: `Privacy Policy | ${siteTheme.brand.name}`,
  description:
    "Learn how M & M Waggy Tales collects, uses, protects, and shares personal information when you visit our website or use our pet-care services.",
};

async function getPrivacyPolicyMarkdown() {
  const policyPath = path.join(process.cwd(), "app", "content", "privacy-policy.md");
